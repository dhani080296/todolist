                         ...
                         <?php $count= $todoList->tasks->count() ?>
                            <li class="list-group-item" id="todo-list-{{ $todoList->id }}">
                                ...
                                <div class="buttons">
                                    <a href="{{route("todolists.show", $todoList->id) }}" class="btn btn-info show-task-modal btn-xs" data-title="{{$todoList->title}}" title="Manage Tasks" data-action="{{ route('todolists.tasks.store', $todoList->id) }}">
